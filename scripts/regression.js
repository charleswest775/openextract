 ...
 *      don't need it).
 *   4. Build the Electron main + renderer bundles.
 *   5. Run the Playwright suite (wraps with xvfb-run on headless Linux).
 *      Its globalSetup generates the synthetic-backup fixtures.
 */
...
// 4. Build. (Fixtures are generated by Playwright's globalSetup.)
run('npm', ['run', 'build']);
