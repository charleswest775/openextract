...
export type TrayIconState = 'idle' | 'connected' | 'syncing' | 'attention';

export class TrayManager {
  private tray: any = null;
  private statusWindow: any = null;
  private iconState: TrayIconState = 'idle';
  private tooltipText: string = 'OpenExtract — Starting...';

  // Callbacks set by main.ts
  public onShowFullUI: (() => void) | null = null;
  public onShowSettings: (() => void) | null = null;
  public onQuickAnalyze: ((objective: string) => void) | null = null;
  public onExtractFromBackup: (() => void) | null = null;
  public onExport: (() => void) | null = null;
  public onQuit: (() => void) | null = null;

  create(iconDir: string): void {
  ...
  setIconState(state: TrayIconState): void {
    ...
    const stateLabels: Record<TrayIconState, string> = {
      idle: 'Idle',
