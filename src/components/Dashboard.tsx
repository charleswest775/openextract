...
import { MessageSquare, Image, Phone, PhoneCall, Users, FileText, Youtube, PanelLeftClose, PanelLeft } from 'lucide-react';
...
type Tab = 'messages' | 'photos' | 'voicemail' | 'calls' | 'contacts' | 'notes' | 'youtube';
